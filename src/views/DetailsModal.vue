        ...
        <ion-content class="ion-padding">
            <ion-card class="ion-text-center ion-padding">
                ...
                <ion-card-content>
                    ...
                    <ion-icon class="icon" aria-label="add to favorites" color="warning"
                        @click="toggleFavorite(catFact, $event)" v-if="isFavorite(catFact)" :icon="star" />
                    <ion-icon class="icon" aria-label="remove from favorites" @click="toggleFavorite(catFact, $event)"
...
import {
    ...
    IonCard, IonCardHeader, IonCardTitle, IonText, IonCardContent, IonIcon
} from "@ionic/vue";
